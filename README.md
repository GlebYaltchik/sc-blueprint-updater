...
и автоматически помечает их в файле локализации — чтобы в магазине и крафте
...
В Star Citizen список чертежей в вашем инвентаре нигде наглядно не отображается
рядом с позициями в магазине. Когда чертежей накапливается несколько десятков,
легко купить дубликат или не заметить нужный.
...
в магазине, на верстаке, в окне крафта.
